  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="Sign out"
        description="You will leave the current workspace on this device. Local vault secrets stay protected and require sign-in again to access synced metadata."
